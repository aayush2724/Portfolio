...
function RoleCycler() {
  ...
  return (
    <div className="h-7 overflow-hidden" style={{ minWidth: 260 }}>
    ...
    >
      ...
      >
        ...
        >
          <MagneticButton
            href="#projects"
            className="relative group px-9 py-4 bg-amber-500 text-black font-display font-semibold rounded-2xl text-sm tracking-wide overflow-hidden hover:shadow-2xl hover:shadow-amber-500/30 transition-shadow duration-300"
          >
          ...
          <MagneticButton
            ...
            className="px-9 py-4 gc border border-white/10 rounded-2xl text-sm font-display font-medium hover:border-amber-500/40 hover:text-amber-400 transition-colors duration-300 flex items-center gap-2"
          >
      ...
      <motion.div
        ...
        className="relative z-10 mt-20 w-full max-w-3xl mx-auto px-6"
      >
