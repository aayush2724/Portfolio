...
const chapters = [
  ...
  },
  {
    ...
    body: "LeetCode became my daily puzzle. Arrays, trees, graphs, DP — each one forced me to slow down and think differently. I'm somewhere in the 300–600 range and still going. It's not about the count, it's about the mindset shift.",
    color: "#06b6d4",
    side: "right",
  },
  {
    ...
    body: "From a cyberpunk visitor management system to a disaster relief coordination platform — I gravitate toward projects with real-world weight. If it solves an actual problem, I'm in.",
    color: "#a855f7",
    side: "left",
  },
  {
